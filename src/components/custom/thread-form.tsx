...
export default function ThreadForm({
  ...
  return (
    <DialogRoot
      ...
      size={{ mdDown: "full", mdTo2xl: "lg" }}
    >
      <DialogContent
        md={{ border: "1px solid #212121" }}
          ...
          >
            ...
            >
              <Box
                display="flex"
                gap="0.5rem"
                md={{ borderBottom: "1px solid #212121" }}
            ...
            <DialogFooter padding="1rem 1.5rem 1rem 1.5rem">
              ...
              >
                ...
                <LuImage
                  ...
                  cursor={
                    state.statusDialog == "add" ? "cursor" : "not-allowed"
                  }
                />
                <Button
                  type="submit"
